---
title: "A-Splines Algorithm - Comparison with competitors"
...
# Our functions
source("C:/Users/Nicolas/OneDrive/Master/Técnico Investigación/Programas/Competidores/Functions.R")
```
...
library(mgcv)
library(pso)
source("C:/Users/Nicolas/OneDrive/Master/Técnico Investigación/Programas/Competidores/ok_gam.R")
```
...
simulation_1 <- function(n, SNR, m, family, ndx, bdeg, lambda.init, k,
  ...
  terms <- paste0("s(V", 1:m, ", bs = 'cr', k = ", k, ")")
  ...
  # PSO: Method = REML in PSO makes BIC() inadequate: Compute it manually
...
return(list(MSE_Wood = MSE1,    # Wood's algorithm results
            ...
            AIC_Wood = AIC1,
            BIC_Wood = BIC1,
            MSE_PSO = MSE2,     # PSO results
            MAE_PSO = MAE2,
            Grid_PSO = grid2,
            K_sel_PSO = result$knots,
            EDF_PSO = EDF2,
            Size_PSO = length(model2$coefficients),
            AIC_PSO = AIC2,
            BIC_PSO = BIC2
))
}
...
covariates_plot_1 <- function(Results, grid, N, m, n, SNR){
  ...
  # PSO
  Grid_PSO_matrices <- lapply(Results, function(x) x$Grid_PSO)
  ...
  Knots_Selected_Wood <- lapply(Results, function(x) x$K_sel_Wood) 
  Knots_Selected_PSO <- lapply(Results, function(x) x$K_sel_PSO) 
  ...
  plot_list <- lapply(1:m, function(t) {
    ...
    knots_Wood <- unlist(lapply(1:N, function(i) Knots_Selected_Wood[[i]][[t]]))
    knots_PSO <- unlist(lapply(1:N, function(i) Knots_Selected_PSO[[i]][[t]]))
    rug_df_Wood <- data.frame(x = knots_Wood)
    rug_df_PSO <- data.frame(x = knots_PSO)
    
    o <- order(X[, t])
    plot <- ggplot() +
      # True effect
      geom_line(aes(x = X[o, t], y = FF[o, t], color = "True effect"), alpha = 0.6, linewidth = 3) +
      # Mean PSO estimations
      geom_line(aes(x = grid[, t], y = mean_Grid_PSO[, t], color = "PSO"), linewidth = 1.1, alpha = 0.8) +
      ...
      geom_rug(data = rug_df_Wood, aes(x = x), sides = "b", color = "#FF3030", alpha = 2/N, linewidth = 2, length = unit(0.1, "npc")) +
      geom_rug(data = rug_df_PSO, aes(x = x), sides = "b", color = "#1C86EE", alpha = 2/N, linewidth = 2, length = unit(0.05, "npc")) +
...
error_plot_1 <- function(Results){
  ...
  MSE_PSO  <- sapply(Results, function(x) x$MSE_PSO)
  MAE_PSO  <- sapply(Results, function(x) x$MAE_PSO)
  EDF_PSO <- sapply(Results, function(x) x$EDF_PSO)
  Size_PSO <- sapply(Results, function(x) x$Size_PSO)
  BIC_PSO <- sapply(Results, function(x) x$BIC_PSO)
  
  df <- data.frame(
    Value = c(MSE_Wood, MSE_PSO, MAE_Wood, MAE_PSO, BIC_Wood, BIC_PSO, EDF_Wood, EDF_PSO, Size_Wood, Size_PSO),
    Metric = rep(c("MSE", "MSE", "MAE", "MAE", "BIC", "BIC", "EDF", "EDF", "Basis Size", "Basis Size"), each = length(Results)),
    Method = rep(c(rep("AKSSAM", length(Results)), rep("PSO", length(Results))), times = 5)
  )
  ...
  plots <- lapply(levels(df$Metric), function(metric_name) {
    if (metric_name!="EDF"){
      ggplot(filter(df, Metric == metric_name), aes(x = Method, y = Value, color = Method)) +
          ...
          ggtitle(metric_name) +
          scale_color_manual(
              values = c("AKSSAM" = "#FF3030", "PSO" = "#1C86EE"),
              name = "Algorithm"
          ) +
...
simulation_wrapper_1 <- function(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                 maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                 epsilon){
  ...
  Results = rep(list(list(MSE_Wood = NA, MAE_Wood = NA, Grid_Wood = NA, 
                          ...
                          MSE_PSO = NA, MAE_PSO = NA,  Grid_PSO = NA, 
                          K_sel_PSO = vector('list', m), EDF_PSO = NA, 
                          AIC_PSO = NA, BIC_PSO = NA, Size_PSO = NA)), N)
  ...
  while (i <= N) {
    ...
    try_result <- try({
      result <- simulation_1(n, SNR, m, family, ndx, bdeg, lambda.init, k,
                             maxiter1, maxiter2, maxiter3, tol1, tol2, tol3, epsilon,
                             grid)
  ...
  err_plot <- suppressWarnings(error_plot_1(Results))
  err_metrics = list(mean_MSE_Wood = NA, sd_MSE_Wood = NA, 
                     ...
                     mean_MSE_PSO = NA, sd_MSE_PSO = NA, 
                     mean_MAE_PSO = NA, sd_MAE_PSO = NA, 
                     mean_AIC_PSO = NA, sd_AIC_PSO = NA, 
                     mean_BIC_PSO = NA, sd_BIC_PSO = NA,
                     mean_EDF_PSO = NA, sd_EDF_PSO = NA,
                     mean_Size_PSO = NA, sd_Size_PSO = NA)
  ...
  # MSE_PSO
  err_metrics$mean_MSE_PSO <- mean(sapply(Results, function(x) x$MSE_PSO), na.rm = TRUE)
  err_metrics$sd_MSE_PSO <- sd(sapply(Results, function(x) x$MSE_PSO), na.rm = TRUE)
  # MAE_PSO
  err_metrics$mean_MAE_PSO <- mean(sapply(Results, function(x) x$MAE_PSO), na.rm = TRUE)
  err_metrics$sd_MAE_PSO <- sd(sapply(Results, function(x) x$MAE_PSO), na.rm = TRUE)
  # AIC_PSO
  err_metrics$mean_AIC_PSO <- mean(sapply(Results, function(x) x$AIC_PSO), na.rm = TRUE)
  err_metrics$sd_AIC_PSO <- sd(sapply(Results, function(x) x$AIC_PSO), na.rm = TRUE)
  # BIC_PSO
  err_metrics$mean_BIC_PSO <- mean(sapply(Results, function(x) x$BIC_PSO), na.rm = TRUE)
  err_metrics$sd_BIC_PSO <- sd(sapply(Results, function(x) x$BIC_PSO), na.rm = TRUE)
  # EDF_PSO
  err_metrics$mean_EDF_PSO <- mean(sapply(Results, function(x) x$EDF_PSO), na.rm = TRUE)
  err_metrics$sd_EDF_PSO <- sd(sapply(Results, function(x) x$EDF_PSO), na.rm = TRUE)
  # Size_PSO
  err_metrics$mean_Size_PSO <- mean(sapply(Results, function(x) x$Size_PSO), na.rm = TRUE)
  err_metrics$sd_Size_PSO <- sd(sapply(Results, function(x) x$Size_PSO), na.rm = TRUE)
...
N = 1   # Nº of simulation repetitions
...
ll_Gaussian_n1S1 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n1S2 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n1S3 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n2S1 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n2S2 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n2S3 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n3S1 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n3S2 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
## Perform the simulations
ll_Gaussian_n3S3 <- simulation_wrapper_1(N, n, SNR, m, family, ndx, bdeg, lambda.init, k,
                                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                         epsilon)
...
names(gaussian_table2) = c('n', 'SNR', 
                           ...
                           "MSE PSO", "MAE PSO", "AIC PSO", "BIC PSO", "EDF PSO", "Size PSO")
...
names(reduced_gaussian_table2) = c('n', 'SNR', 
                           ...
                           "MSE PSO", "MAE PSO", "BIC PSO", "EDF PSO", "Size PSO")
...
```{r}
# Checkpoint
save.image(file = "competitors.RData")
```
...
simulation_2 <- function(n, m, family, ndx, bdeg, lambda.init, k,
                         maxiter1, maxiter2, maxiter3, tol1, tol2, tol3, epsilon,
                         grid){
...
simulation_wrapper_2 <- function(N, n, m, family, ndx, bdeg, lambda.init, k,
                                 maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                 epsilon){
  ...
  while (i <= N) {
    ...
    # Simulate once the situation with error handling
    try_result <- try({
      result <- simulation_2(n, m, family, ndx, bdeg, lambda.init, k,
                             maxiter1, maxiter2, maxiter3, tol1, tol2, tol3, epsilon,
                             grid)
  ...
  ## Error metrics plot and values
  err_plot <- suppressWarnings(error_plot_2(Results))
  err_metrics = list(mean_MSE_Wood = NA, sd_MSE_Wood = NA, 
                     mean_MAE_Wood = NA, sd_MAE_Wood = NA, 
                     mean_AIC_Wood = NA, sd_AIC_Wood = NA, 
                     mean_BIC_Wood = NA, sd_BIC_Wood = NA,
...
## Perform the simulations
ll_Poisson_n1 <- simulation_wrapper_2(N, n, m, family, ndx, bdeg, lambda.init, k,
                                      maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                      epsilon)
...
## Perform the simulations
ll_Poisson_n2 <- simulation_wrapper_2(N, n, m, family, ndx, bdeg, lambda.init, k, 
                                      maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                      epsilon)
...
## Perform the simulations
ll_Poisson_n3 <- simulation_wrapper_2(N, n, m, family, ndx, bdeg, lambda.init, k,
                                      maxiter1, maxiter2, maxiter3, tol1, tol2, tol3,
                                      epsilon)
